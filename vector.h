...
void subtract_vector(struct vector2d* a, struct vector2d* b);

struct vector2d subtract_vector_new(struct vector2d* a, struct vector2d* b);
...
float dot_product3d(struct vector3d *v1, struct vector3d *v2);
